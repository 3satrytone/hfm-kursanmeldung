...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'accept_file_types' => '/\.(gif|jpe?g|png|mp3|mp4|wav|mpeg|aiff|wmv|txt|pdf)$/i',
    ...
    protected function jo_repl_file_name($filename) {
        // Remove umlauts:
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error,
        ...
        $name = $this->jo_repl_file_name($name);
        return $name;
    }
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $this->copyToPath($file_path,$_SERVER['DOCUMENT_ROOT'].'/uploads/tx_jokursanmeldung/'.$file->name);
        return $file;
    }
    ...
    public function copyToPath($file,$toPath){
        copy($file, $toPath);
    }
}
